...
#define N_PARAM (377)
#define FLOP_ESTIMATE (730 + 20 * G_ESTIMATE)
...
struct generatedFcnInterest {
  ...
  FCN_ATTRIBUTES 
   inline const char* name() {return "autoencoder 16x10x1x10x16 function";}
...

{
   ...
   h2_0 += h1_8 * p[179];
   h2_0 += h1_9 * p[180];
   register float h3_0 = p[181];
   register float h3_1 = p[182];
   register float h3_2 = p[183];
   register float h3_3 = p[184];
   register float h3_4 = p[185];
   register float h3_5 = p[186];
   register float h3_6 = p[187];
   register float h3_7 = p[188];
   register float h3_8 = p[189];
   register float h3_9 = p[190];
   h3_0 += h2_0 * p[191];
   h3_1 += h2_0 * p[192];
   h3_2 += h2_0 * p[193];
   h3_3 += h2_0 * p[194];
